...
async function addQuestion() {
    try {
        ...
        // Check for duplicate
        const existing = await Question.findOne({ text: 'What do you do?', image: 'q_art_3.png' });
        if (existing) {
            ...
            options: [
                {
                    text: 'Show Answer',
                    isCorrect: true,
                    explanation: 'In female RMD patients with Remission/Stable/Low Disease Activity and a Negative aPL Test, the recommendation is to proceed with Assisted Reproductive Technology (ART).'
                }
            ],
            summary: 'Assisted Reproductive Technology (ART) in female RMD patients: If disease activity is low and aPL status is negative, ART can proceed as strongly recommended.',
            diagram: true,
            difficulty: 'medium',
            image: 'q_art_3.png',
            image2: 'a_art_3.png',
        ...
        console.log('✅ Question 17 added successfully!');
