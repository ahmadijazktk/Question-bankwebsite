export const questions = [
  {
    ...
    options: [
      {
        text: "Potentiometry",
        explanation: "Potentiometry is an electroanalytic method that measures the potential of a solution between two electrodes to determine the concentration of an analyte in the solution.",
        isCorrect: false
      },
      {
        text: "Fluorometry",
        explanation: "The detector is perpendicular to the light source. This is important so that the light from the source is unable to interfere with the fluorescent light being measured. The monochromator is used to vary the wavelength. Nephelometry, which measures scattered light, also places the detector perpendicular to the light source.",
        isCorrect: true
      },
      {
        text: "Turbidimetry",
        explanation: "A turbidimeter measures light parallel to the source. Turbidimetry measures the deflection of light from undissolved particles. Nephelometry, which measures scattered light, places the detector perpendicular to the sample.",
        isCorrect: false
      },
      {
        text: "Coulometry",
        explanation: "Coulometry measures the electric current passed through an analyte.",
        isCorrect: false
      },
      {
        text: "Chromatography",
        explanation: "Chromatography separates the components of solute mixtures, by a distribution of the solutes through two phases: polar and non-polar.",
        isCorrect: false
      }
    ],
